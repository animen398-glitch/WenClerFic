...
## Шаг 1: Найти нужный API

Вы находитесь на странице **API Library** (API-библиотека).

1. В поисковой строке введите: **"Google Identity"** или **"OAuth"**
2. Найдите и выберите: **"Google Identity API"** или **"Google+ API"**
